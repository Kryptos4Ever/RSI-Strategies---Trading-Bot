...
class BaseStrategy(ABC):
    ...
    def get_chart_overlay_config(self) -> list:
        ...
        BacktestEngine lo incluye en chart_data.overlays del JSON y fusiona
    ...
    def get_chart_overlay_row(self, candle_ts) -> dict:
        ...
        El BacktestEngine lo fusiona inline en la vela correspondiente de
    ...
    def get_param_display_map(self) -> dict:
        ...
        El BacktestEngine lo incluye en parametros.param_display_map del
