...
class BinanceDataDownloader:
    def __init__(self, db_name="btc_1h.db"):
    ...
    def create_database(self):
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_datetime ON btc_1h(datetime)')
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_timestamp ON btc_1h(timestamp)')
    ...
    def show_database_info(self):
        ...
        cursor.execute("SELECT datetime FROM btc_1h ORDER BY timestamp LIMIT 1")
        first_record = cursor.fetchone()

        cursor.execute("SELECT datetime FROM btc_1h ORDER BY timestamp DESC LIMIT 1")
