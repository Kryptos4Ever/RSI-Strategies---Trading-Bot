"""
Backtest_RSI_Standard.py — Lanzador específico para RSI Standard
══════════════════════════════════════════════════════════════════
Configura y ejecuta un backtest para la estrategia RSI Standard
(Cutler's RSI) con un selector simple de parámetros al inicio del archivo.
...
log = get_logger("backtest_rsi_standard_runner")
