"""
tests/optimizadores/test_optimizador_rsi_standard.py
═══════════════════════════════════════════════════════════════════
Verifica que el optimizador RSI Standard produce resultados idénticos al
backtest individual (Backtest_RSI_Standard.py) para 3 combinaciones
...
# ══════════════════════════════════════════════════════════════════════════════
# HELPER: Replica el flujo de Backtest_RSI_Standard.py
# ══════════════════════════════════════════════════════════════════════════════
...
def run_individual_backtest(
    ...
    """
    Replica EXACTAMENTE el flujo de Backtest_RSI_Standard.py
...
class TestOptimizadorRSIStandard:
    """
    Tests de validación del Optimizador_RSI_Standard.
    
    Para cada combinación, ejecuta:
    1. El flujo completo (replica Backtest_RSI_Standard.py)
    ...
    def test_optimizador_vs_backtest_individual(self, synthetic_candles, combo):
        ...
        """
        # ── 1. Ejecutar flujo individual (replica Backtest_RSI_Standard.py) ──
        summary_individual = run_individual_backtest(synthetic_candles, combo)

        # ── 2. Ejecutar worker del optimizador ──
        from Optimizador_RSI_Standard import run_single_combo_lightweight
    ...
    def test_optimizador_produce_top20(self, synthetic_candles):
        ...
        """
        from Optimizador_RSI_Standard import Top20Leaderboard
    ...
    def test_optimizador_checkpoint_roundtrip(self, tmp_path):
        ...
        """
        from Optimizador_RSI_Standard import CheckpointManager
