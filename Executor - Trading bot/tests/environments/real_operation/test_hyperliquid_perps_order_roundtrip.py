"""
test_hyperliquid_mainnet_order_roundtrip.py — Test REAL contra Hyperliquid Perps (Mainnet)
=========================================================================================
Ejecuta operaciones reales en Hyperliquid Perps Mainnet con confirmación del usuario.
...
REQUISITOS:
  - .env: HL_SECRET_KEY, HL_ACCOUNT_ADDRESS, HL_SYMBOL=BTC
  - Saldo disponible en Hyperliquid Mainnet
...
class TestHyperliquidPerpsOrderRoundtrip:
    """Test de operación real contra Hyperliquid Perps Mainnet."""

    @pytest.fixture(scope="class")
    def clients(self):
        """Crea los clientes de Hyperliquid Mainnet."""
        require_confirmation("Hyperliquid Perps (Mainnet)", "Full Roundtrip (Market + Limit GTC + Post-Only)")
        ...
        if not secret_key or not account_address:
            pytest.skip("HL_SECRET_KEY o HL_ACCOUNT_ADDRESS no configurados en .env")
        ...
        log_event("CLIENTES_INICIALIZADOS", exchange="HL Mainnet", symbol=symbol)
    ...
    def test_full_roundtrip(self, clients, sz_decimals):
        ...
        log_event("BALANCE_INICIAL", account_value=initial_balance)
