...
class RSIStandardStrategy(BaseStrategy):
    ...
    def on_candle(self, candle: Candle, wallet) -> List[Signal]:
        ...
        if rsi < 50.0:
            ...
            # Precio de reducción LONG (autónomo vía reduce_long, calculado con inversa estándar)
        ...
        # ── ZONA SHORT: RSI > 50 (punto neutral de la media) ──────────────
            ...
            # Precio de reducción SHORT (autónomo vía reduce_short, calculado con inversa estándar)
